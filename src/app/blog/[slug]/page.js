...
const BlogPost = () => {
  ...
  if (!post) return <div className="no-posts"><p>Technical document not found.</p><Link href="/blog">Back to Listing</Link></div>;
      ...
      <section className="post-body-container">
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <div className="post-footer" style={{ marginTop: '80px', borderTop: '1px solid #eee', paddingTop: '40px' }}>
            <Link href="/blog" className="read-more-link"><span>←</span> Back to Technical Feed</Link>
          </div>
        </div>
      </section>
    </div>
