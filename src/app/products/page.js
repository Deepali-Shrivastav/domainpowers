...
const ltThyristorImg = "/assets/images/DP_LT_THYRISTOR_APFC_PANEL_2.png";
        ...
        <div className="container">
          <div className="product-listing-grid">
            {products.map((product, index) => (
              ...
              >
                <Link href={`/product/${product.id}`} className="card-inner">
        ...
        <div className="container">
          ...
          >
            ...
            <div className="cta-btns">
               <Link href="/contact" className="btn btn-primary">Schedule Site Audit</Link>
               <Link href="/contact" className="btn btn-outline-white">Technical Inquiry</Link>
            </div>
          </motion.div>
        </div>
      </section>
